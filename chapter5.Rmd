...
From the correlation plot we can see that the percentage of female representatives in parliament and the ratio of females to males in the labour force do not correlate strongly with any of the other variables ($\mathit{r} \le \pm .25$). Their strongest correlation is between each other.

The strongest correlation coefficients ($\mathit{r} \ge\pm.7$) can be found between  

* Maternal mortality ratio and life expectancy ($\mathit{r}=-.86$)  
* Expected years of schooling and life expectancy ($\mathit{r}=.79$)  
* Maternal mortality ratio and adolescent birth ratio ($\mathit{r}=.76$)  
* Expected years of schooling and maternal mortality ratio ($\mathit{r}=-.74$)  
* Adolescent birth ratio and life expectancy ($\mathit{r}=-.73$)  
* Expected years of schooling and adolescent birth ratio ($\mathit{r}=-.7$)  
...
When analysed through principal component 1, the first grouping is a polar opponent to the third grouping, with both adolescent births and maternal mortality decreasing when GNI, life expectancy, and education levels increase.  
...
```{r Tea time column drop and plot}
